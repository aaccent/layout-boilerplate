...
export function getMapContainer<TMapContainer extends MapContainer = MapContainer>(container: string | HTMLElement): TMapContainer {
...
export function getMapCenter(mapContainer: MapContainer): [ number, number ] {
	return !mapContainer.dataset.coords
	  ? [ 55.796951, 49.210983 ]
	  : parseCoords(mapContainer.dataset.coords)
}